"""
Django settings for Focus Health Academy project.
...
# Allow all hosts in development (you can restrict this in production)
...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='focus_health_academy'),
...
# Stripe configuration (set these in your environment or .env)
...
# Frontend domain used for checkout redirects (optional)
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='Focus Health Academy <noreply@focushealthacademy.com>')
...
if not DEBUG:
    ...
    CSRF_TRUSTED_ORIGINS = [
        'https://api.focushealth-academy.com',
        'https://focushealth-academy.com',
        'https://www.focushealth-academy.com',
    ]
